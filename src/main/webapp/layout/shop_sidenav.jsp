...
<aside id="sidebar-multi-level-sidebar" class="fixed top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
   <div class="h-full px-5 py-4 overflow-y-auto bg-gray-50 dark:bg-gray-800">
      ...
      <div class="">
         ...
         <li >
               <a href="/DMS/views/shop/createOrder.jsp" class="mb-4 mx-auto border-b-4 shadow-lg hover:border-y-2 border-blue-800 bg-blue-600 flex items-center justify-center px-6 py-2 text-gray-900 rounded-lg dark:text-white group">
         ...
         <li>
            <a href="/DMS/views/shop/home.jsp" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
         ...
         <li>
            <a href="/DMS/views/shop/updateProfile.jsp" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
